...
class IndividualBeneficiaryExtractor extends BeneficiaryExtractor[IndividualBeneficiary] {
  ...
  override def apply(answers: UserAnswers, individualBeneficiary: IndividualBeneficiary, index: Int): Try[UserAnswers] =

    super
      .apply(answers, individualBeneficiary, index)
  ...
  private def extractCountryOfNationality(
