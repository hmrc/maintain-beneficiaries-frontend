...
trait BeneficiaryExtractor[T <: Beneficiary] {
  ...
  def extractUserAnswersForOrgBeneficiary(answers: UserAnswers, entity: OrgBeneficiary): Try[UserAnswers] =
    answers
  ...
  def extractUserAnswersForIncomeBeneficiary(answers: UserAnswers, entity: IncomeBeneficiary): Try[UserAnswers] =
