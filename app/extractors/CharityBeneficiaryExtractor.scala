...
class CharityBeneficiaryExtractor extends BeneficiaryExtractor[CharityBeneficiary] {

  override def apply(answers: UserAnswers, charityBeneficiary: CharityBeneficiary, index: Int): Try[UserAnswers] =

    super
      .apply(answers, charityBeneficiary, index)
