  ...
  def apply(userAnswers: UserAnswers, beneficiaryName: String)(implicit messages: Messages) = {
    ...
    AnswerSection(
      ...
      Seq(
        ...
        bound.intQuestion(IncomePercentagePage, "individualBeneficiary.incomePercentage", controllers.individualbeneficiary.add.routes.IncomePercentageController.onPageLoad().url),
