  ...
  def apply(userAnswers: UserAnswers, beneficiaryName: String)(implicit messages: Messages) = {
    ...
    AnswerSection(
      ...
      Seq(
        ...
        bound.roleInCompanyQuestion(RoleInCompanyPage, "individualBeneficiary.roleInCompany", controllers.individualbeneficiary.amend.routes.RoleInCompanyController.onPageLoad().url),
        ...
        bound.percentageQuestion(IncomePercentagePage, "individualBeneficiary.shareOfIncome", controllers.individualbeneficiary.amend.routes.IncomePercentageController.onPageLoad().url),
        ...
        bound.ninoQuestion(NationalInsuranceNumberPage, "individualBeneficiary.nationalInsuranceNumber", controllers.individualbeneficiary.amend.routes.NationalInsuranceNumberController.onPageLoad().url),
