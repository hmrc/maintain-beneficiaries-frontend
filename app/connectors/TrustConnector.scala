...
class TrustConnector @Inject() (http: HttpClientV2, config: FrontendAppConfig) {
  ...
  def addClassOfBeneficiary(identifier: String, beneficiary: ClassOfBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendClassOfBeneficiary(identifier: String, index: Int, description: String)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def addIndividualBeneficiary(identifier: String, beneficiary: IndividualBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendIndividualBeneficiary(identifier: String, index: Int, individual: IndividualBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def addCharityBeneficiary(identifier: String, beneficiary: CharityBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendCharityBeneficiary(identifier: String, index: Int, beneficiary: CharityBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def addTrustBeneficiary(identifier: String, beneficiary: TrustBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendTrustBeneficiary(identifier: String, index: Int, beneficiary: TrustBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def addCompanyBeneficiary(identifier: String, beneficiary: CompanyBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendCompanyBeneficiary(identifier: String, index: Int, beneficiary: CompanyBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def addEmploymentRelatedBeneficiary(identifier: String, beneficiary: EmploymentRelatedBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendEmploymentRelatedBeneficiary(
    identifier: String,
    index: Int,
    beneficiary: EmploymentRelatedBeneficiary
  )(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[HttpResponse] = {
    val url: String = s"$beneficiariesUrl/amend-large/$identifier/$index"
    http.post(url"$url").withBody(Json.toJson(beneficiary)).execute[HttpResponse]
  }

  def addOtherBeneficiary(identifier: String, beneficiary: OtherBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendOtherBeneficiary(identifier: String, index: Int, beneficiary: OtherBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def removeBeneficiary(identifier: String, beneficiary: RemoveBeneficiary)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
