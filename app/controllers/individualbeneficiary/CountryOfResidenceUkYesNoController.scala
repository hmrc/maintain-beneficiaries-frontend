...
import pages.individualbeneficiary.CountryOfResidenceUkYesNoPage
...
class CountryOfResidenceUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("individualBeneficiary.countryOfResidenceUkYesNo")
