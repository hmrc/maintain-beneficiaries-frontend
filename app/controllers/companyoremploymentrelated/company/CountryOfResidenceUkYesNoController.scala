...
import pages.companyoremploymentrelated.company.CountryOfResidenceUkYesNoPage
...
class CountryOfResidenceUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("companyBeneficiary.countryOfResidenceUkYesNo")
