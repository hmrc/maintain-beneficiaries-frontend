...
import pages.companyoremploymentrelated.employment.CountryOfResidenceUkYesNoPage
...
class CountryOfResidenceUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("employmentBeneficiary.countryOfResidenceUkYesNo")
