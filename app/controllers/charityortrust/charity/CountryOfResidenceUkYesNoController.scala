...
import pages.charityortrust.charity.CountryOfResidenceUkYesNoPage
...
class CountryOfResidenceUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("charityBeneficiary.countryOfResidenceUkYesNo")
