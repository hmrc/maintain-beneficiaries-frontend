...
import pages.charityortrust.trust.CountryOfResidenceUkYesNoPage
...
class CountryOfResidenceUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("trustBeneficiary.countryOfResidenceUkYesNo")
