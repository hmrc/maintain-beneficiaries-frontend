...
import pages.charityortrust.trust.CountryOfResidenceYesNoPage
...
class CountryOfResidenceYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("trustBeneficiary.countryOfResidenceYesNo")
