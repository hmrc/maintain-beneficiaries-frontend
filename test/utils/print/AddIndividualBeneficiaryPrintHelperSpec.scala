    ...
    "generate individual beneficiary section for all possible data" in {
      ...
      result mustBe AnswerSection(
        ...
        rows = Seq(
          ...
          AnswerRow(label = Html(messages("individualBeneficiary.roleInCompany.checkYourAnswersLabel", name.displayName)), answer = Html("Not a director or employee"), changeUrl = controllers.individualbeneficiary.add.routes.RoleInCompanyController.onPageLoad().url),
          ...
          AnswerRow(label = Html(messages("individualBeneficiary.shareOfIncome.checkYourAnswersLabel", name.displayName)), answer = Html("50%"), changeUrl = controllers.individualbeneficiary.add.routes.IncomePercentageController.onPageLoad().url),
          ...
          AnswerRow(label = Html(messages("individualBeneficiary.nationalInsuranceNumber.checkYourAnswersLabel", name.displayName)), answer = Html("AA 00 00 00 A"), changeUrl = controllers.individualbeneficiary.add.routes.NationalInsuranceNumberController.onPageLoad().url),
