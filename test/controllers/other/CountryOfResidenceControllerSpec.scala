...
import pages.other.{CountryOfResidencePage, DescriptionPage}
...
import views.html.other.CountryOfResidenceView

class CountryOfResidenceControllerSpec extends SpecBase {

  private val form: Form[String] = new CountryFormProvider().withPrefix("otherBeneficiary.countryOfResidence")
  ...
  "CountryOfResidenceController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(form, NormalMode, description, countryOptions)(request, messages).toString
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(validAnswer), NormalMode, description, countryOptions)(request, messages).toString
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, NormalMode, description, countryOptions)(request, messages).toString
