...
import pages.other.{CountryOfResidenceUkYesNoPage, DescriptionPage}
...
class CountryOfResidenceUkYesNoControllerSpec extends SpecBase {
  ...
  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("otherBeneficiary.countryOfResidenceUkYesNo")
  private val onPageLoadRoute: String = routes.CountryOfResidenceUkYesNoController.onPageLoad(NormalMode).url
  private val description: String = "Charity"
  ...
  "CountryOfResidenceUkYesNoController" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(true), NormalMode, description)(request, messages).toString
