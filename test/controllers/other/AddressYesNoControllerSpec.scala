...
class AddressYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val addressYesNoRoute: String = routes.AddressYesNoController.onPageLoad(mode).url
  ...
  "AddressYesNo Controller" must {
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request = FakeRequest(POST, addressYesNoRoute).withFormUrlEncodedBody("value" -> "")
