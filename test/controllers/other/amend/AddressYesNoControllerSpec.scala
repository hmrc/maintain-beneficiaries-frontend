...
import pages.other.{AddressYesNoPage, DescriptionPage}
import play.api.data.Form
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.other.amend.AddressYesNoView

class AddressYesNoControllerSpec extends SpecBase with MockitoSugar {

  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("otherBeneficiary.addressYesNo")
