...
class DiscretionaryIncomeYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val discretionaryIncomeYesNoRoute = routes.DiscretionaryIncomeYesNoController.onPageLoad(index).url
  ...
  "DiscretionaryIncomeYesNo Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[DiscretionaryIncomeYesNoView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(DiscretionaryIncomeYesNoPage(index), true).success.value
