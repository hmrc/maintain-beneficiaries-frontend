...
import pages.charityortrust.charity.{CountryOfResidenceYesNoPage, NamePage}
...
class CountryOfResidenceYesNoControllerSpec extends SpecBase {
  ...
  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("charityBeneficiary.countryOfResidenceYesNo")
