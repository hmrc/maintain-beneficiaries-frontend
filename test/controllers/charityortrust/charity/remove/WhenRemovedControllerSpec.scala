...
class WhenRemovedControllerSpec extends SpecBase with MockitoSugar {
  ...
  private def form = formProvider.withPrefixAndTrustStartDate("charityBeneficiary.whenRemoved", LocalDate.now())
  ...
  def charityBeneficiary(id: Int) = CharityBeneficiary(
