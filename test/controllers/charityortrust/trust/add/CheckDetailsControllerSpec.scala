...
import views.html.charityortrust.trust.add.CheckDetailsView
...
class CheckDetailsControllerSpec extends SpecBase with MockitoSugar with ScalaFutures {
  ...
  "CheckDetails Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val printHelper = application.injector.instanceOf[AddTrustBeneficiaryPrintHelper]
    ...
    "redirect to the 'add a beneficiary' page when submitted" in {
      ...
      when(mockTrustConnector.addTrustBeneficiary(any(), any())(any(), any())).thenReturn(Future.successful(HttpResponse(OK)))
