...
import pages.charityortrust.trust.{CountryOfResidencePage, NamePage}
...
class CountryOfResidenceControllerSpec extends SpecBase {
  ...
  private val form: Form[String] = new CountryFormProvider().withPrefix("trustBeneficiary.countryOfResidence")
