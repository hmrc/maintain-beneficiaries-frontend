...
import pages.charityortrust.trust.{NamePage, ShareOfIncomePage}
...
class ShareOfIncomeControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val form: Form[Int] = new IncomePercentageFormProvider().withPrefix("trustBeneficiary.shareOfIncome")
