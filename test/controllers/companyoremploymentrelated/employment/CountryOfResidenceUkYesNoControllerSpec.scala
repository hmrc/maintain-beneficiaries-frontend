...
import pages.companyoremploymentrelated.employment.{CountryOfResidenceUkYesNoPage, NamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.companyoremploymentrelated.employment.CountryOfResidenceUkYesNoView

class CountryOfResidenceUkYesNoControllerSpec extends SpecBase {

  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("employmentBeneficiary.countryOfResidenceUkYesNo")
  ...
  "CountryOfResidenceUkYesNoController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[CountryOfResidenceUkYesNoView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val answers = baseAnswers.set(CountryOfResidenceUkYesNoPage, true).success.value
