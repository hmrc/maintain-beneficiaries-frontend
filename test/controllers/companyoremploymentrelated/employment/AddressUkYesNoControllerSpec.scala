...
import views.html.companyoremploymentrelated.employment.AddressUkYesNoView
...
class AddressUkYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val addressUkYesNoRoute: String = routes.AddressUkYesNoController.onPageLoad(NormalMode).url
  ...
  "AddressUkYesNo Controller" must {
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request = FakeRequest(POST, addressUkYesNoRoute).withFormUrlEncodedBody("value" -> "")
