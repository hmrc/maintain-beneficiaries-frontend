...
import pages.companyoremploymentrelated.company.{CountryOfResidencePage, NamePage}
...
import views.html.companyoremploymentrelated.company.CountryOfResidenceView

class CountryOfResidenceControllerSpec extends SpecBase {

  private val form: Form[String] = new CountryFormProvider().withPrefix("companyBeneficiary.countryOfResidence")
