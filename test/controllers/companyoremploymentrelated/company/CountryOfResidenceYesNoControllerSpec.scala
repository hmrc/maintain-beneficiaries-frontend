...
import pages.companyoremploymentrelated.company.{CountryOfResidenceYesNoPage, NamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.companyoremploymentrelated.company.CountryOfResidenceYesNoView

class CountryOfResidenceYesNoControllerSpec extends SpecBase {

  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("companyBeneficiary.countryOfResidenceYesNo")
