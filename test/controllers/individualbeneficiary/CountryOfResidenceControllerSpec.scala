...
import pages.individualbeneficiary.{CountryOfResidencePage, NamePage}
...
class CountryOfResidenceControllerSpec extends SpecBase {
  ...
  private val form: Form[String] = new CountryFormProvider().withPrefix("individualBeneficiary.countryOfResidence")
