...
import pages.individualbeneficiary.{CountryOfNationalityYesNoPage, NamePage}
...
class CountryOfNationalityYesNoControllerSpec extends SpecBase {
  ...
  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("individualBeneficiary.countryOfNationalityYesNo")
