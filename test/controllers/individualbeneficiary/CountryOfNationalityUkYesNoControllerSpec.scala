...
import pages.individualbeneficiary.{CountryOfNationalityUkYesNoPage, NamePage}
...
class CountryOfNationalityUkYesNoControllerSpec extends SpecBase {

  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("individualBeneficiary.countryOfNationalityUkYesNo")
  private val onPageLoadRoute: String = routes.CountryOfNationalityUkYesNoController.onPageLoad(NormalMode).url
  ...
  "CountryOfNationalityUkYesNoController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[CountryOfNationalityUkYesNoView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val answers = baseAnswers.set(CountryOfNationalityUkYesNoPage, true).success.value
