...
import pages.individualbeneficiary.{CountryOfNationalityPage, NamePage}
...
class CountryOfNationalityControllerSpec extends SpecBase {
  ...
  private val form: Form[String] = new CountryFormProvider().withPrefix("individualBeneficiary.countryOfNationality")
