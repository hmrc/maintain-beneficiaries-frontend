...
import navigation.trustBeneficiary.AddTrustBeneficiaryNavigator
import org.scalatestplus.scalacheck.ScalaCheckPropertyChecks
import pages.charityortrust.trust._

class AddTrustBeneficiaryNavigatorSpec extends SpecBase with ScalaCheckPropertyChecks  {

  val navigator = new AddTrustBeneficiaryNavigator
