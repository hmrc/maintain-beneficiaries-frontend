...
class CountryOfResidenceUkYesNoViewSpec extends YesNoViewBehaviours {
  ...
  val messageKeyPrefix = "individualBeneficiary.countryOfResidenceUkYesNo"
  ...
  "CountryOfResidenceUkYesNoView" must {
    ...
    behave like yesNoPage(form, applyView, messageKeyPrefix, Some(name.displayName), routes.CountryOfResidenceUkYesNoController.onSubmit(NormalMode).url)
