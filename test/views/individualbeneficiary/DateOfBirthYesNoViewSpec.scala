...
import views.html.individualbeneficiary.DateOfBirthYesNoView

class DateOfBirthYesNoViewSpec extends YesNoViewBehaviours {

  val messageKeyPrefix = "individualBeneficiary.dateOfBirthYesNo"
  ...
  "DateOfBirthYesNo view" must {
    ...
    behave like yesNoPage(
      ...
      routes.DateOfBirthYesNoController.onSubmit(NormalMode).url
    )
