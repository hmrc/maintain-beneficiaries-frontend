...
class DiscretionYesNoViewSpec extends YesNoViewBehaviours {
  ...
  val messageKeyPrefix = "otherBeneficiary.discretionYesNo"
  ...
  "DiscretionYesNo view" must {
    ...
    behave like yesNoPage(form, applyView, messageKeyPrefix, Some(description), routes.DiscretionYesNoController.onSubmit().url)
