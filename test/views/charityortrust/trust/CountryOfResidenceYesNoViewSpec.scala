...
import controllers.charityortrust.trust.routes
...
class CountryOfResidenceYesNoViewSpec extends YesNoViewBehaviours {
  ...
  val messageKeyPrefix = "trustBeneficiary.countryOfResidenceYesNo"
  ...
  "CountryOfResidenceYesNoView" must {
    ...
    behave like yesNoPage(
      ...
      messageKeyPrefix,
      Some(name),
      routes.CountryOfResidenceYesNoController.onSubmit(NormalMode).url
    )
